...
var appTheme = ThemeData(
  ...
  textTheme: typography.black.copyWith(
    ...
    headline3: typography.black.headline3.copyWith(fontSize: 24, fontWeight: FontWeight.w500),
...
var darkTheme = ThemeData(
  ...
  textTheme: typography.white.copyWith(
    ...
    headline3: typography.white.headline3.copyWith(fontSize: 24, fontWeight: FontWeight.w500),
    headline4: typography.white.headline4.copyWith(fontSize: 24, fontWeight: FontWeight.w300),
